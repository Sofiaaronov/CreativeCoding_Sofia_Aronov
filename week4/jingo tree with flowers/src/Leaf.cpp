...
//    rotation = _branchAngle + PI/2 + ofRandom(-(PI/2), PI/2); //bring in angle of branch
    rotation = _branchAngle - PI/2 + ofRandom(-(PI/4), PI/4); //bring in angle of branch
...
if(season == 0){
    leafColor = ofColor(ofRandom(247,245),ofRandom(239,197),ofRandom(8,4), ofRandom(150,255)); //set to random green color
}
if(season == 1){
    leafColor = ofColor(ofRandom(236,155),ofRandom(192,59),ofRandom(16,11),ofRandom(150,255));  //set to random green color
}
if(season == 2){
leafColor = ofColor(ofRandom(187,255),ofRandom(236,255),ofRandom(255,255),ofRandom(150,240));  //set to random green color
}
if(season == 3){
...
void LeafSmaller::setup(float _branchAngle, int _season){
    ...
    stemLength = ofRandom(50,100);
    stemWidth = ofRandom(2,4);
    leafLength = ofRandom(50,100);
    leafWidth = ofRandom(50,125);
    leafCurvature = ofRandom(1, 5);
    rotation = _branchAngle + PI/2 + ofRandom(-(PI/2), PI/2); //bring in angle of branch
    rotation = rotation * (180/PI); //convert to degrees (from radians) to use for ofRotateZ() below, which expects degrees...
...
void LeafSmaller::update(){
    
}

void LeafSmaller::draw(float _xPos, float _yPos){

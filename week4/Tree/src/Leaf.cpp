...
void Leaf::setup(float _branchAngle, int _season){
    ...
    if(season == 0 || season == 3){
        ...
        if(randomNumber >= 0 && randomNumber <1){
            leafColor = ofColor(ofRandom(100,150),69,19,ofRandom(150,255)); //brown
        }
        if(randomNumber >= 1 && randomNumber < 2) {
            leafColor = ofColor(ofRandom(200,250),20,19, ofRandom(150,255)); //red
        }
        if(randomNumber >= 2 && randomNumber < 3) {
            leafColor = ofColor(ofRandom(100,150),ofRandom(200,250),19, ofRandom(150,255)); //yellow
        }
    }
